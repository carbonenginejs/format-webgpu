import { Tr2EffectBindingManifest } from "@carbonenginejs/format-hlsl";
import { enumerateUniqueEffectBodies } from "@carbonenginejs/format-hlsl/portable";
...
function resolveBody(effectRes, permutationIndex, source)
{
    ...
    const resolved = {
        ...
        effectDescription,
        bindingManifest: Tr2EffectBindingManifest.fromEffectDescription(effectDescription),
